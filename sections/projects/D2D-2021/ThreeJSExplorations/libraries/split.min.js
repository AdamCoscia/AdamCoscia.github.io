...
!(function (e, t) {
  ...
  return function (r, s) {
    ...
    function N(e) {
      ...
      this.dragging &&
        ...
        t <= n.minSize + C + this._b
          ? (t = n.minSize + this._b)
          : t >= this.size - (r.minSize + C + this._c) && (t = this.size - (r.minSize + this._c)),
        T.call(this, t),
        a(s, "onDrag", i)());
    }
    function q() {
    ...
    "horizontal" === U
      ? ((d = "width"), (f = "clientX"), (v = "left"), (m = "right"), (g = "clientWidth"))
      : "vertical" === U && ((d = "height"), (f = "clientY"), (v = "top"), (m = "bottom"), (g = "clientHeight")),
      (S = H(S));
    var X = [];
    function Y(e) {
      var t = e.i === X.length,
    ...
    return (
      (p = y.map(function (e, t) {
        ...
        if (
          t > 0 &&
          (((n = { a: t - 1, b: t, dragging: !1, direction: U, parent: z })._b = u(k, t - 1 == 0, !1, x)),
          ...
          X.forEach(function (n) {
            if (
              (!0 !== t
                ...
                : (n.gutter.removeEventListener("mousedown", n._a), n.gutter.removeEventListener("touchstart", n._a)),
              !0 !== e)
            ) {
